    ...
    <main class="flex-1 ml-64">
        ...
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div
                    class="align-middle rounded-tl-lg rounded-tr-lg inline-block w-full py-4 overflow-hidden bg-white px-6">
                    <div class="flex justify-between">
                        <div class="inline-flex border rounded w-96 px-2 lg:px-4 h-12 bg-transparent">
                            <div class="flex flex-wrap items-stretch w-full h-full mb-6 relative">
                                <div class="flex">
                                    <span
                                        class="flex items-center leading-normal bg-transparent rounded rounded-r-none border border-r-0 border-none lg:px-1 py-2 whitespace-no-wrap text-grey-dark text-sm">
                ...
                <div class="ml-auto px-14 py-6">
                    <button type="button"
                        class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create
                        New Mail</button>
                </div>
            </div>
        </div>
            ...
            <table class="min-w-full">
                <thead>
                    <tr>
                        ...
                        <th
                            class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-grey tracking-wider">
                            INSTANSI</th>
                        <th
                            class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-grey tracking-wider">
                            PERIHAL</th>
