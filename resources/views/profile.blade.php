            ...
            <div class="grid grid-cols-1 gap-4 mt-4 ">
                ...
                <div>
                    ...
                    <input id="division" type="text" disabled
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        placeholder="Division" value="{{ $profile['division']['name'] }}">
                </div>
                <!-- Alamat -->
                <div>
                    ...
                    <input id="address" type="text" disabled
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        placeholder="Address" value="{{ $profile['address'] }}"></input>
                </div>
                <!-- Tanggal Lahir -->
                <div>
                    ...
                    <input id="birthDate" type="text" disabled
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        placeholder="Birth Date" value="{{ \Carbon\Carbon::parse($profile['birthDate'])->format('d-m-Y') }}">
                </div>
                <!-- Nomor HP -->
                <div>
                    ...
                    <input id="phoneNumber" type="text" disabled
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        placeholder="Phone Number" value="{{ $profile['phoneNumber'] }}">
                </div>
                <!-- Jenis Kelamin -->
                <div>
                    ...
                    <input id="sex" type="text" disabled
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        placeholder="M/L" value="{{ ($profile['sex'] == 'M'?'Male':'Female') }}">
                </div>
                <!-- Button -->
